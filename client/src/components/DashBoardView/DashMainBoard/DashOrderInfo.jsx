...
export default function DashOrderInfo() {
  return (
        ...
        <table className="MuiTable-root">
          <thead className="MuiTableHead-root">
            <tr className="MuiTableRow-root MuiTableRow-head">
              ...
              <th
                className="MuiTableCell-root MuiTableCell-head jss40"
                scope="col"
              >
                <h3 className="MuiBox-root jss41">Order ID</h3>
              </th>
              <th className="MuiTableCell-root MuiTableCell-head" scope="col">
                <h3 className="MuiBox-root jss42">Date</h3>
              </th>
            </tr>
          </thead>
          <tbody className="MuiTableBody-root">
            <tr className="MuiTableRow-root jss43">
              <td className="MuiTableCell-root MuiTableCell-body jss44">
              ...
              <th
                className="MuiTableCell-root MuiTableCell-body jss44"
                role="cell"
                scope="row"
              >
                <div className="MuiBox-root jss47">-MNf4f3SHq_TjQsmGDpV</div>
              </th>
              <td className="MuiTableCell-root MuiTableCell-body jss44">
            ...
            <tr className="MuiTableRow-root jss43">
              <td className="MuiTableCell-root MuiTableCell-body jss44">
                <div className="MuiBox-root jss49">
                  <svg
                    className="MuiSvgIcon-root"
                    focusable="false"
                    viewBox="0 0 24 24"
              ...
              <th
                ...
                scope="row"
              >
                <div className="MuiBox-root jss50">-MNfDqhAo1W2JfLugVuJ</div>
              </th>
              <td className="MuiTableCell-root MuiTableCell-body jss44">
                <div className="MuiBox-root jss51">
